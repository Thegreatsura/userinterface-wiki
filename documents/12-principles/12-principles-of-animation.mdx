...
The 12 Principles of Animation provide a framework for creating more engaging and lifelike animations. Developed by Disney animators in the 1930s, they emphasize the importance of understanding the underlying mechanics of movement and how to apply them effectively.[^1]
...
<figure>
  ...
  <figcaption>Family's Wallet Icon Picker[^2]</figcaption>
</figure>
...
Above shows a few of the widely used easing functions. Check out [easing.dev](https://easing.dev) for a more comprehensive list, as well as the ability to create your own.[^5]
...
/>
  <figcaption>Apple's Dynamic Island.[^6]</figcaption>
</figure>
...
<figcaption>Linear Orbit[^7]</figcaption>
</figure>
...
<figcaption>A small scrollable sample of delightful creations on the web.[^8]</figcaption>
</figure>
